...
public class BodyPartFragment extends Fragment {
    ...
    public static final String IMAGE_LIST_STATE = "image_list_state";
    public static final String LIST_INDEX_STATE = "list_index_state";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            mImageIds = savedInstanceState.getIntegerArrayList(IMAGE_LIST_STATE);
    ...
    public void onSaveInstanceState(Bundle outState) {
        outState.putIntegerArrayList(IMAGE_LIST_STATE, (ArrayList<Integer>) mImageIds);
